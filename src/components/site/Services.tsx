...
export function Services() {
  return (
    <section id="servicios" className="bg-ink text-paper py-16 md:py-40">
      <div className="mx-auto max-w-[1600px] px-5 md:px-12">
        <header className="reveal mb-12 md:mb-32 max-w-4xl">
          ...
          <p className="mt-6 md:mt-8 text-paper/70 max-w-2xl text-base md:text-lg font-light">
